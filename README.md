...
> **エンドポイント:** `https://gemini-image-mcp.vercel.app/api/mcp`
...
**Claude.ai（Web）:**
Settings → MCP → Add:
- URL: `https://gemini-image-mcp.vercel.app/api/mcp`
...
```json
{
  "mcpServers": {
    "gemini-image": {
      "command": "npx",
      "args": ["-y", "mcp-remote", "https://gemini-image-mcp.vercel.app/api/mcp"],
      "env": {
...
**Claude Code:**
```bash
claude mcp add --transport http gemini-image https://gemini-image-mcp.vercel.app/api/mcp \
